...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "http://192.168.1.24:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://192.168.1.24:7051, peer1.org1.example.com@grpc://192.168.1.24:7056");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://192.168.1.24:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://192.168.1.24:7053,peer1.org1.example.com@grpc://192.168.1.24:7058");
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.ca_location", "http://192.168.1.24:8054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpc://192.168.1.24:8051,peer1.org2.example.com@grpc://192.168.1.24:8056");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpc://192.168.1.24:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpc://192.168.1.24:8053, peer1.org2.example.com@grpc://192.168.1.24:8058");
    ...
    private Properties getEndPointProperties(final String type, final String name) {
        ...
        File cert = Paths.get(getTestChannelPath(),
                "crypto-config/ordererOrganizations".replace("orderer", type), domainName, type + "s",
